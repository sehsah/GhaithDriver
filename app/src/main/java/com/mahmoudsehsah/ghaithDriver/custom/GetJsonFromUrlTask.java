...
import com.mahmoudsehsah.ghaithDriver.acitivities.ShowMarketActivity;
...
public class GetJsonFromUrlTask extends AsyncTask<Void, Void, String> {
    ...
    protected void onPreExecute() {
        ...
        Typeface typeFace = Typeface.createFromAsset(activity.getAssets(), "font/jf.ttf");
...
//        dialog.show();
    ...
    protected void onPostExecute(String result) {
        ((ShowMarketActivity) activity).parseJsonResponse(result);
        dialog.dismiss();
        Log.i(TAG, result);
    }
